...
public class AtyNanXie extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.aty_fenlei_nanzxie);
		nList = (ListView) findViewById(R.id.fenlei_nanxie);
		// 接受分类页面类别id参数
		...
		NetHttpData.getHttpDao().getFenLeiGoods(classify + "", new JsonHttpResponseHandler("utf-8") {
			...
			public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
				...
				try {
					...
					NanAdapter = new NanZAdapter(AtyNanXie.this, JsonList);
					nList.setAdapter(NanAdapter);
	...
	public void dianJi() {
		nList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				Intent in = new Intent(AtyNanXie.this, AtyXiangQing.class);
				Bundle b = new Bundle();
