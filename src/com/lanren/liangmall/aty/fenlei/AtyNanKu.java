...
public class AtyNanKu extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.aty_fenlei_nanku);
		nList = (ListView) findViewById(R.id.fenlei_nanku);
		...
		NetHttpData.getHttpDao().getFenLeiGoods(classify + "", new JsonHttpResponseHandler("utf-8") {
			...
			public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
				...
				try {
					...
					NanAdapter = new NanZAdapter(AtyNanKu.this, JsonList);
	...
	public void dianJi() {
		nList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				Intent in = new Intent(AtyNanKu.this, AtyXiangQing.class);
				Bundle b = new Bundle();
