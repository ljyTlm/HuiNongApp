...
public class AtyNanZhuang extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.aty_fenlei_nanzhuang);
		nList = (ListView) findViewById(R.id.fenlei_nanzhuang);
		...
		NetHttpData.getHttpDao().getFenLeiGoods(classify + "", new JsonHttpResponseHandler("utf-8") {
			...
			public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
				...
				try {
					...
					NanAdapter = new NanZAdapter(AtyNanZhuang.this, JsonList);
